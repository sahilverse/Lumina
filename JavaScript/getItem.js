...
if (storedProducts === null || storedProducts.length === 0) {
    itemCount = 0;
    showCount(itemCount);
    container.innerHTML += `<div class = "emptyCart" style="width: 100%; display: flex; justify-content: center; align-items: center"><p>"Cart is Empty"</p></div>`
} else {
...
/*  Remaining work:
 ...
 1. Checkout functionality still pending.
